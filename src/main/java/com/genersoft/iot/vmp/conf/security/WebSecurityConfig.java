...
//    private LoginUserAccessDeniedHandler accessDeniedHandler;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                // 放行接口
//                .antMatchers("/api/user/login", "/index/hook/**", "/api/device/query/devices/**/ChannelsByDeviceId", "/api/play/start/**/**").permitAll()
                .antMatchers("/api/user/login", "/index/hook/**", "/api/device/query/devices/**/ChannelsByDeviceId", "/api/play/start/**/**",
                        "/api/device/query/devices", "/api/device/query/devices/**/channels").permitAll()
                // 除上面外的所有请求全部需要鉴权认证
